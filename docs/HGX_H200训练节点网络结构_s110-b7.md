...
| `r07u57 / r08u31` | 两台 Leaf 的机柜列 / U 位 |
| `IPMI` | 带外 BMC 管理口 |
| `S110-D*-U*-PSU*` | 电源馈电（PDU / Bank） |

实拍标签示例：`s110-b7-IBBZ-p2`、`cls01-s110-r07u57-bz-leaf-1`、`cls01-s110-r08u31-bz-leaf-2`、`s110-b7-IPMI`。
...
← [返回 README](../README.md) · 相关：[s110 集群网络架构（交换机与 CPU 服务器）](s110集群网络架构_交换机与CPU服务器.md) · [GPU 集群常见问题与故障排查手册](GPU集群常见问题与故障排查手册.md) · [B300/GB300 NVL72 技术全解](B300_GB300_NVL72_技术全解.md)
